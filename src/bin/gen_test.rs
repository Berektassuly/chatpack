...
const SENDERS: &[&str] = &[
    "Alice", "Bob", "Иван", "Мария", "村上", "محمد",
    "User;With;Semicolons", "User\"With\"Quotes", "User\nWith\nNewlines",
    "", "   ", "🔥FireUser🔥", "A̷̧̛̜l̶̨̛͓i̸̧̛̜c̷̨̛͓ȩ̸̛̜", // Zalgo name
];
...
fn generate_telegram(count: usize, output: &str) {
    ...
    for i in 0..count {
        ...
        if (i + 1) % 10000 == 0 {
            ...
            eprint!("\r   Generated {}/{} ({:.1} MB, {:.0} msg/s)", i + 1, count, mb, mps);
        }
    }
